...
public class AddTalkActivity extends Activity {
	...
	protected void addtalk(String name) {
		// TODO Auto-generated method stub
		String url="http://6.worldcup2.sinaapp.com/secretary/AddTalk.php";
		Map map=new HashMap();
		map.put("pid",pid);
		map.put("ttheme",name);
	...
	private void post_u(int sid, String email) {
		// TODO Auto-generated method stub
		String url="http://6.worldcup2.sinaapp.com/secretary/Addt_u.php";
		Map map=new HashMap();
		map.put("tid",sid);
